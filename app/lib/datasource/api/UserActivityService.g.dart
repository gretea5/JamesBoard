...
class _UserActivityService implements UserActivityService {
  ...
  Future<UserActivityDetailResponse> getUserActivityDetail(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserActivityDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/user-activity/detail',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    logger.d("getUserActivityDetail result : ${_result}");
    late UserActivityDetailResponse _value;
    try {
      _value = UserActivityDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
