        ...
        children: [
          ...
          if (!isMe) ...[
            Row(
              ...
              children: [
                ImageCommonUserCircle(
                    imageUrl: 'assets/image/icon_agent_q.png'),
                        ...
                        if (isMe) ...[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(
                                left: 43, right: 8, bottom: 4), // 여백 조정
                            child: Text(
                              time,
                              style: TextStyle(
                                fontSize: 12,
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                softWrap: true, // 텍스트가 자동으로 줄 바꿈되도록 설정
                              ),
                            ),
                          ),
                        ],
                        ...
                        if (!isMe) ...[
                          ...
                          Align(
                            alignment: isMe
                                ...
                                : Alignment.bottomLeft, // 하단 정렬
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  left: 8, right: 22, bottom: 4), // 여백 조정
                              child: Text(
                                time,
                                style: TextStyle(
                                  fontSize: 12,
