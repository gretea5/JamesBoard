...
class ItemUserGenrePercentInfo extends StatefulWidget {
  ...
  const ItemUserGenrePercentInfo(
      {super.key, required this.genre, required this.percent});

  @override
  State<ItemUserGenrePercentInfo> createState() =>
      _ItemUserGenrePercentInfoState();
}
...
class _ItemUserGenrePercentInfoState extends State<ItemUserGenrePercentInfo> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        leading: ClipOval(
          child: Container(width: 30, height: 30, color: mainParty),
        ),
        title: Text(
          widget.genre,
          style: TextStyle(
